# -*- coding: utf-8 -*-
#########################################################################################
# Cactus Tracker v1.0.6 / January 12, 2015
...
class CactusHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def generate_graph(self, data, title, **args):
        ...
        pylab.figure(figsize = (964 / 100.0, height / 100.0), dpi = 100)
    ...
    def send_page(self, pending, smooth):
        ...
        mode, heater, heaterFrom, heaterTo, humidity = AUTO, 0, 5, 10, None
        for s in flog:
